			...
			<?php while ( have_posts() ) : the_post(); ?>
				<article <?php post_class(); ?>>
					...
					<div class="entry-content entry-attachment">
						...
						<p><strong><?php _e( 'URL:', 'horizon-theme' ); ?></strong> <a href="<?php echo wp_get_attachment_url(); ?>" title="<?php the_title_attribute(); ?>" rel="attachment"><span><?php echo basename( wp_get_attachment_url() ); ?></span></a></p>
